%% ========================================================================
%                   simulation for fiscal variables
% =========================================================================

   function data = fiscal_simulation(data)
...
%  generate waitbar
   wb = waitbar(0,'simulating fiscal variables, please wait...')          ;   
...
%          risk premium    
           theta = 1                                                      ; % tasa de recuperaci�n

%          coefiente aversi�n al riesgo CRRA alhpa
%          alpha = 0 
